...
busco --offline --in Genome_sequences/Asbolus_verrucosus.fna --out Asbolus_verrucosus.endopterygota.busco --lineage_dataset endopterygota_odb10 --mode genome --cpu 32 -f
